...
const MissionStatement = ({ props: { formData, handleChange } }) => {
    ...
    <div className={styles.missionStatementWrapper}>
      ...
      <div className={styles.sectionWrapper}>
        ...
        <div>
          ...
          <ul>
            <li>
              What is the key problem you are hoping to address with your
              Project?
            </li>
            <li>How will you measure the success of your Project?</li>
            <li>
              How will your Project provide an immediate and widespread benefit
              to the broader Stacks Ecosystem?
            </li>
            <li>
              How will your Project advance the mission of a user-owned internet
              powered by Stacks and secured by Bitcoin?
            </li>
            <li>
              What are the risks associate with your project and how do you

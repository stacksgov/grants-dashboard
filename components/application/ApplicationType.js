...
const ApplicationType = () => {
	...
	return (
		<Form title="Application Type" description="What type of an application is this?">
			<Radio
				name="applicationType"
				value="This is an application for a grant that I intend to complete myself or as part of a team."
			/>
			<Radio name="applicationType" value="This is just an idea I want to add to the Wishlist." />
			<Radio
				id="existingWishlist"
				name="applicationType"

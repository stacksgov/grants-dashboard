				...
				<div className={styles.radioWrapper}>
					...
					<div>
						<div className={styles.radio}>
							...
							/>
							<label>
								This is a direct application, I intend to perform the work myself or as part of a
								team.
							</label>
						</div>
					</div>
				...
				<div className={styles.radioWrapper}>
					...
					<div>
						<div className={styles.radio}>
							...
							/>
							<label>
								This is an application for a project I want to add to the Wishlist and hope someone
								else applies to complete it.
							</label>
						</div>
					</div>
					<div>
						<div className={styles.radio}>
							...
							/>
							<label>
								This is an application I found on the Wishlist that I wish to complete. (paste issue
								url below)
							</label>
						</div>
					</div>
